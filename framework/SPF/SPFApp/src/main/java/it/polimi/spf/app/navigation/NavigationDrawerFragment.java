...
/**
 * Subclass of {@link NavigationFragment} to handle the navigation within the
 * main activity with a {@link NavigationDrawerFragment} layout.
...
public class NavigationDrawerFragment extends NavigationFragment {
	...
	protected void selectItem(int position, boolean replace) {
		...
		super.selectItem(position, replace);
	}
